"""Controller zwischen NiceGUI-Oberfläche und Services.

Die UI ruft den Controller auf. Der Controller leitet an Services weiter und hält den aktuellen Wochenplan.
"""
...
class MenuMasterController:
    """Vermittelt zwischen NiceGUI-Seiten und Services."""
    ...
    def wochenplan_speichern(self) -> Wochenplan:
        """Speichert den aktuell bearbeiteten Wochenplan."""
    ...
    def einkaufsliste_anzeigen(self) -> list[str]:
        """Berechnet Textzeilen für die Einkaufsliste des aktuellen Plans."""
