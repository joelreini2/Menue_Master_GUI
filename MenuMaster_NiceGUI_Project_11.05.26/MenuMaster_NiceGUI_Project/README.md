...
Screenshots können nach dem ersten vollständigen GUI-Lauf in `docs/ui-images/` ergänzt werden.

---

## 🏛️ Architecture

![Schichtenübersicht](docs/architecture-diagrams/schichten.md)
...
Die Tests konzentrieren sich auf die Teile, die für Anfänger gut verständlich und stabil testbar sind: Domain-Klassen, Validierung und Einkaufsliste.

**Test mix:**

- 6 Unit Tests
- Validierung von Zutaten
- Validierung von Rezepten
- Validierung von Wochenplänen
- Prüfung der sieben Wochentage
- Einkaufsliste fasst gleiche Zutaten korrekt zusammen
...
3. Preconditions – Voraussetzungen
4. Test steps – Testschritte
5. Test data/input – Eingabedaten
6. Expected result – Erwartetes Ergebnis
7. Actual result – Tatsächliches Ergebnis
8. Status – pass/fail
9. Comments – Bemerkungen
...
| Name      | Contribution |
|-----------|--------------|
| Joel N.   | NiceGUI-Oberfläche, Darstellung, README |
| Joel R.   | Rezepte, ORM-Modelle, Datenbankzugriff |
| Lukas B.  | Wochenplan-Logik, Einkaufsliste, Tests |

Die Namen und Beiträge können vor der finalen Abgabe noch angepasst werden.
...
|---|---|
| Funktionalität | Rezepte, Wochenplan, automatische Befüllung, Speicherung, Einkaufsliste und Historie sind vorgesehen bzw. im Code angelegt. |
...
| Präsentation | README enthält Use Cases, Architektur, Datenmodell und Begründungen für Designentscheidungen. |
| Dokumentation | README ist nach dem Pizza-Projekt aufgebaut und auf MenuMaster angepasst. |
| Projektmanagement & Engagement | Aufgabenverteilung und klare Projektstruktur sind dokumentiert. |
